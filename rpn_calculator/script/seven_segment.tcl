...
set_location_assignment PIN_P8 -to seg1[6]
set_location_assignment PIN_P6 -to seg1[7]

set_location_assignment PIN_R10 -to seg2[0]
set_location_assignment PIN_T9  -to seg2[1]
set_location_assignment PIN_R9  -to seg2[2]
set_location_assignment PIN_R8  -to seg2[3]
...
set_location_assignment PIN_R11 -to seg3[5]
